...
class ShopEditor(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        item_category_header.setToolTip(
            self.tr(
                "The category of the item that appears in the shop.\n"
                + "Is defined in the localizable.tsv file and the text behind it cannot be edited here."
            )
        )

        layout.addWidget(self._item_shop_table)

        self.add_row_button = QtWidgets.QPushButton(self.tr("Add Item"), self)
        self.add_row_button.clicked.connect(self.add_row)  # type: ignore
        layout.addWidget(self.add_row_button)

        self.reset_button = QtWidgets.QPushButton(
            self.tr("Reset To Original Game Data"), self
        )
    ...
    def show_context_menu(self, pos: QtCore.QPoint):
        ...
        if column == Rows.IMAGE.value:
            replace_image_action = menu.addAction("Replace Image")
    ...
    def remove_row(self):
        self.msg_box = ui_dialog.Dialog.yes_no_box(
            ...
            self.tr("Remove Item"),
            self.tr("Are you sure you want to remove this item?"),
            self.tr("Remove"),
    ...
    def fill_table(self):
        ...
        for item_index, shop_item in self.item_shop.items.items():
            ...
            if item_category_str is None:
                item_category_str = shop_item.category_name + " (failed to localize)"
