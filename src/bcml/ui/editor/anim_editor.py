...
class AnimViewerPage(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self._layout.addWidget(self.anim_viewer_box, 0, 0, 1, 1)
        ...
        self._layout.addWidget(self.part_viewer_box, 0, 1, 1, 1)
...
class TimeLine(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self._layout.addWidget(self.left_pannel_scroll_area)
        ...
        self._layout.addWidget(self.time_line_scroll_area)
        ...
        self._layout.addWidget(self.left_pannel_time_line_splitter)
...
class AnimEditor(QtWidgets.QWidget):
    ...
    def setup_top_half(self):
        self.anim_viewer_page = AnimViewerPage(self.model, self, self.anim_id)
    ...
    def set_frame(self, frame: int):
        ...
        self.anim_viewer_page.part_viewer_box.part_viewer.set_frame(frame)
        self.anim_viewer_page.anim_viewer_box.update()
