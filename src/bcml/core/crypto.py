...
class AesCipher:
    ...
    @staticmethod
    def get_cipher_from_pack(pack: "game_data.pack.PackFile"):
        aes_mode = AES.MODE_CBC
        if pack.country_code == country_code.CountryCode.JP:
            key = "d754868de89d717fa9e7b06da45ae9e3"
            iv = "40b2131a9f388ad4e5002a98118f6128"
        elif pack.country_code == country_code.CountryCode.EN:
            key = "0ad39e4aeaf55aa717feb1825edef521"
            iv = "d1d7e708091941d90cdf8aa5f30bb0c2"
        elif pack.country_code == country_code.CountryCode.KR:
            key = "bea585eb993216ef4dcb88b625c3df98"
            iv = "9b13c2121d39f1353a125fed98696649"
        elif pack.country_code == country_code.CountryCode.TW:
            key = "313d9858a7fb939def1d7d859629087d"
            iv = "0e3743eb53bf5944d1ae7e10c2e54bdf"
        else:
            raise Exception("Unknown country code")
        enable = not pack.is_image_data_local_pack()
        if pack.is_server_pack():
            aes_mode = AES.MODE_ECB
            key = (
                Hash(HashAlgorithm.MD5, io.data.Data("battlecats"))
                .get_hash(8)
                .to_hex()
            )
