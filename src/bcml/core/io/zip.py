...
class Zip:
    def __init__(self, file_data: Optional["data.Data"] = None):
        ...
        self.zip = zipfile.ZipFile(self.file_data, mode=mode, compression=zipfile.ZIP_DEFLATED)
    ...
    def get_file(self, file_name: "path.Path", show_error: bool = False) -> Optional["data.Data"]:
        try:
