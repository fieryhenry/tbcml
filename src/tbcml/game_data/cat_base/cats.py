...
class FormStats:
    ...
    target_red: bool | None = None
    unused: int | None = None
    area_attack: bool | None = None
    attack_1_foreswing: int | None = None
    min_z_layer: int | None = None
    max_z_layer: int | None = None
    target_floating: bool | None = None
    target_black: bool | None = None
    target_metal: bool | None = None
    target_traitless: bool | None = None
    target_angel: bool | None = None
    target_alien: bool | None = None
    target_zombie: bool | None = None
    ...
    resistant: bool | None = None
    massive_damage: bool | None = None
    crit_prob: int | None = None
    attacks_only: bool | None = None
    extra_money: bool | None = None
    ...
    lethal_strike_prob: int | None = None
    ...
    zombie_killer: bool | None = None
    witch_killer: bool | None = None
    target_witch: bool | None = None
    attacks_before_set_attack_state: int | None = None
    shockwave_immune: bool | None = None
    ...
    barrier_break_prob: int | None = None
    ...
    target_eva: bool | None = None
    eva_killer: bool | None = None
    target_relic: bool | None = None
    curse_immunity: bool | None = None
    insanely_tough: bool | None = None
    insane_damage: bool | None = None
    ...
    toxic_immunity: bool | None = None
    surge_immunity: bool | None = None
    curse_prob: int | None = None
    curse_duration: int | None = None
    wave_is_mini: bool | None = None
    shield_pierce_prob: int | None = None
    target_aku: bool | None = None
    collossus_slayer: bool | None = None
    soul_strike: bool | None = None
    ...
    behemoth_slayer: bool | None = None
    behemoth_dodge_prob: int | None = None
    behemoth_dodge_duration: int | None = None
    unknown_108: int | None = None
    counter_surge: bool | None = None
    summon_id: int | None = None
    sage_slayer: bool | None = None
...
@dataclass
class UnitBuy:
    stage_unlock: int | None = None
    purchase_cost: int | None = None
    upgrade_costs: list[int] | None = None
    unlock_source: int | None = None
    rarity: int | None = None
    position_order: int | None = None
    chapter_unlock: int | None = None
    sell_price: int | None = None
    gatya_rarity: int | None = None
    original_max_base: int | None = None
    original_max_plus: int | None = None
    force_tf_level: int | None = None
    second_form_unlock_level: int | None = None
    unknown_22: int | None = None
    tf_id: int | None = None
    uf_id: int | None = None
    evolve_level_tf: int | None = None
    evolve_level_uf: int | None = None
    evolve_cost_tf: int | None = None
    evolve_items_tf: list[int] | None = None
    evolve_cost_uf: int | None = None
    evolve_items_uf: list[int] | None = None
    max_base_no_catseye: int | None = None
    max_base_catseye: int | None = None
    max_plus: int | None = None
    gatya_ofset_y_1st: int | None = None
    gatya_ofset_y_2nd: int | None = None
    gatya_ofset_y_3rd: int | None = None
    gatya_ofset_y_4th: int | None = None
    catseye_usage_pattern: int | None = None
    game_version: int | None = None
    np_sell_price: int | None = None
    unknown_59: int | None = None
    unknown_60: int | None = None
    egg_val: int | None = None
    ...
    def set_max_level(
        ...
        max_base: int,
        max_plus: int,
        level_until_catsye_req: int | None = None,
        original_base_max: int | None = None,
        original_plus_max: int | None = None,
    ):
...
class NyankoPictureBook:
    is_displayed_in_cat_guide: bool | None = None
    limited: bool | None = None
    total_forms: int | None = None
    hint_display_type: int | None = None
    scale_1st: int | None = None
    scale_2nd: int | None = None
    scale_3rd: int | None = None
    scale_4th: int | None = None
...
class CatTalents:
    ...
    @staticmethod
    def find_index(cat_id: int, csv: tbcml.CSV) -> int | None:
        for _ in csv:
            try:
...
class CatForm:
    ...
    """
    cat_guide_text: list[str] | None = None
    ...
    def apply_csv(
        self,
        name_csv: tbcml.CSV | None,
        stat_csv: tbcml.CSV | None,
        cat_guide_text_csv: tbcml.CSV | None,
        game_data: tbcml.GamePacks | None,
        cat_id: int | None,
    ):
    ...
    def set_form(self, form: int | tbcml.CatFormType, cat_id: int):
...
@dataclass
class CatEvolveText:
    first_evol: list[str] | None = None
    blank: str | None = None
    second_evol: list[str] | None = None
...
class Cat(tbcml.Modification):
    ...
    forms: dict[tbcml.CatFormType, CatForm] | None = None
    unitbuy: UnitBuy | None = None
    nyanko_picture_book: NyankoPictureBook | None = None
    evolve_text: CatEvolveText | None = None
    talents: CatTalents | None = None

    def get_form_create(self, form: int | tbcml.CatFormType):
        if isinstance(form, int):
            form = tbcml.CatFormType.from_index(form)
    ...
    def get_form(self, form: int | tbcml.CatFormType) -> CatForm | None:
        if isinstance(form, int):
            form = tbcml.CatFormType.from_index(form)
    ...
    @staticmethod
    def get_total_cats(game_data: tbcml.GamePacks) -> int | None:
    ...
    def apply_unit_buy(self, unit_buy_csv: tbcml.CSV | None):
        if self.unitbuy is not None and unit_buy_csv is not None:
            self.unitbuy.apply_csv(self.cat_id, unit_buy_csv)

    def apply_nyanko_picture_book(self, nyanko_picture_book_csv: tbcml.CSV | None):
    ...
    def read_unit_buy_csv(self, csv: tbcml.CSV | None):
        if csv is None:
            return
        self.get_unitbuy().read_csv(self.cat_id, csv)

    def read_nyanko_picture_book_csv(self, csv: tbcml.CSV | None):
        if csv is None:
            return
        self.get_nyanko_picture_book().read_csv(self.cat_id, csv)

    def read_evolve_text_csv(self, csv: tbcml.CSV | None):
        if csv is None:
            return
        self.get_evolve_text().read_csv(self.cat_id, csv)

    def read_talents_csv(self, csv: tbcml.CSV | None):
        if csv is None:
            return
    ...
    def add_ultra_form_catfruit_evol(
        ...
        evolve_level: int = 40,
        evolve_text: list[str] | None = None,
        cat_guide_text: list[str] | None = None,
    ):
        if form is not None:
