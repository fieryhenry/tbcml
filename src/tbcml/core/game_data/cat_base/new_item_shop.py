...
@dataclass
class CustomItemShop(core.Modification):
    items: Optional[dict[int, "CustomShopItem"]] = None
    ...
    def read_texture(self, game_data: "core.GamePacks"):
        sprite_name = f"item000_{game_data.new_localizable.get_lang()}.png"
        imgcut_name = f"item000_{game_data.new_localizable.get_lang()}.imgcut"
    ...
    def set_item(self, item: "CustomShopItem", shop_id: Optional[int] = None):
