...
class FormStats:
    ...
    def apply_csv(self, form_type: "CatFormType", csv: "core.CSV"):
    ...
    def read_csv(self, form_type: "CatFormType", csv: "core.CSV"):
        index = form_type.get_index()
        csv.index = index
...
@dataclass
class Cat(core.Modification):
    cat_id: int = field(metadata={"required": True})
    forms: Optional[dict["core.CatFormType", CatForm]] = None
    ...
    def set_form(self, form: CatForm, form_type: Optional["core.CatFormType"] = None):
